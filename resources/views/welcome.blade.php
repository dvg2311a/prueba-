    ...
    <main>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 d-flex flex-wrap">
                        ...
                        <p class="d-flex me-4 mb-0">
                            ...
                            <strong class="text-white">¡Hola, Usuario080!</strong>
                        </p>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav align-items-lg-center ms-auto me-lg-5">
                        ...
                        <li class="menu2">
                            ...
                            <a class="dropdown "  href="#section_1">Actividades</a>
                            <ul class="submenu">

                                <li><a href="{{ route ('tests.index') }}">Test</a></li>

                               <!-- <li><a href="{{route('pays.index')}}">Música</a></li>-->

                                <li><a href="{{ route('mediafiles.index') }}">Multimedia</a></li>

                                <li><a href="{{ route('excercises.index') }}">Ejercicios</a></li>

                                <li><a href="{{ route('calendars.index') }}">Calendario</a></li>

                               <!-- <li><a href="news.html">Alarma</a></li>-->
                        ...
                        <li class="nav-item">
                            <a class="nav-link " href="#section_2">¿Qué es Hypnix?</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="#section_3">Sobre nosotros</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="#section_4">.......</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link " href="#section_5">Planes</a>
                        </li>

                        <li class"nav-item">
                            <a class="nav-link" href="#section_6">Preguntas frecuentes</a>
                        </li>
                    </ul>

                    <a href="ticket.html" class="btn custom-btn d-lg-block d-none">Comprar planes</a>
                </div>
            </div>
        </nav>
            ...
            <div class="container d-flex justify-content-center align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-auto mb-5 text-center">
                        ...
                        <h1 class="text-white mb-5">¡Bienvenido a Hypnix!</h1>
                    </div>
        ...
        <section class="about-section section-padding" id="section_2">
            ...
            <!--<div class="container4">
                <img src="images/mujer.jpg"   height: 90px; width: 190px;>
            </div>-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            <h2 class="text-white mb-4">¿Qué es Hypnix?</h2>

                            <p class="text-white">Hypnix es una aplicación que está especialmente diseñada para tratar el trastorno del sueño.</p>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-text-wrap">
                            <img src="images/campo.jpg" class="about-image img-fluid">

                            <div class="about-text-info d-flex">
                                <div class="container5">
                                    <i class="about-text-icon">
                                    <img src="images/kevin.jpeg" class="about-text-icon" >
                                    </i>


                                    <div class="ms-3-0>">
                                        <div class="mov1">
                                        <small> kevin Cardenas/Designer senior</small>
                                        </div>
                                    </div>
                                ...
                                <div class="ms-4">
                                    ...
                                    <p class="mb-0">Me ha ayudado a mejorar los ciclos de sueño, ya que antes de usarla
                                        por lo general dormía solo 2 horas, pero gracias a la aplicación
                                        puedo decir que duermo 8 horas diarias y continuas</p>
                                </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="images/artists/bielka.jpeg"
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="images/artists/sam.jpeg"
                                    class="artists-image img-fluid">
                            </div>
